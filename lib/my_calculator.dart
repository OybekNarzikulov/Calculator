...
class _MyCalculatorState extends State<MyCalculator> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        toolbarHeight: MediaQuery.of(context).orientation == Orientation.landscape ? 15 : 30,
        centerTitle: true,
                ...
                : Column(
                    children: [
                      Row(
                        mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                        children: <Widget>[
                          calcbutton_2('7', Colors.grey.shade800, Colors.white, 20),
                          calcbutton_2('8', Colors.grey.shade800, Colors.white, 20),
                          calcbutton_2('9', Colors.grey.shade800, Colors.white, 20),
                          calcbutton_2(
                      ...
                      Row(
                        ...
                        children: <Widget>[
                          //this is button Zero
                          RaisedButton(
                            padding: EdgeInsets.fromLTRB(188, 10, 185, 10),
                            onPressed: () {
                              calculation('0');
                            },
